      ...
      <Container>
        <Row className="mt-3 mb-3 justify-content-center">
          <Card style={{ width: '16rem', marginLeft: '5%' }}>
            ...
            <Card.Text>
              Upon startup, this appplication connects to an instance of MongoDB
              to store information securely and efficiently.
            </Card.Text>
          </Card>
          <Card style={{ width: '16rem', marginLeft: '5%' }}>
            <Card.Title>Add your shopify stores</Card.Title>
            <Card.Text>Seamlessly add your stores by clicking below.</Card.Text>
